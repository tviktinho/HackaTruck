...
struct SongView: View {
    ...
    var body: some View {
        ZStack{
            ...
            }.padding(.bottom, 650)//hora, wifi, etc
            VStack{
...
#Preview {
    SongView(info: Song(name: "Babe U" , artist: "BRZZA, Aggix", capa: "https://m.media-amazon.com/images/I/41LPq28rnYL._UXNaN_FMjpg_QL85_.jpg"))
}
